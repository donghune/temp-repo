...
public final class Post implements Model {
  ...
  public static final QueryField POST_IMAGE = field("Post", "postImage");
  public static final QueryField AUTHOR = field("Post", "postAuthorId");
  private final @ModelField(targetType="ID", isRequired = true) String id;
  private final @ModelField(targetType="String", isRequired = true) String content;
  private final @ModelField(targetType="String") String postImage;
  private final @ModelField(targetType="User") @BelongsTo(targetName = "postAuthorId", type = User.class) User author;
  ...
  private final @ModelField(targetType="Like") @HasMany(associatedWith = "postLikesId", type = Like.class) List<Like> likes = null;
  ...
  private Post(String id, String content, String postImage, User author) {
    this.id = id;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), post.getId()) &&
              ...
              ObjectsCompat.equals(getPostImage(), post.getPostImage()) &&
  ...
  @Override
   public String toString() {
    return new StringBuilder()
      ...
      .append("postImage=" + String.valueOf(getPostImage()) + ", ")
  ...
  public interface BuildStep {
    ...
    BuildStep postImage(String postImage);
  ...
  public static class Builder implements ContentStep, BuildStep {
    ...
    @Override
     public BuildStep postImage(String postImage) {
        this.postImage = postImage;
        return this;
    }
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String content, String postImage, User author) {
      super.id(id);
    ...
    @Override
     public CopyOfBuilder postImage(String postImage) {
      return (CopyOfBuilder) super.postImage(postImage);
    }
